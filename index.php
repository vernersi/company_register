...
$file = new \App\File('https://data.gov.lv/dati/dataset/4de9697f-850b-45ec-8bba-61fa09ce932f/resource/25e80bf3-f107-4ab4-89ef-251b5b9374e9/download/register.csv', ';');
foreach ($file->getRecords() as $record) {
    $companies->addCompany(new Company($record["name"], $record["regcode"]));
}

echo "[1] Print last 30 elements" . PHP_EOL . "[2] Search company by name" . PHP_EOL . "[3] Search company by registration code" . PHP_EOL;
